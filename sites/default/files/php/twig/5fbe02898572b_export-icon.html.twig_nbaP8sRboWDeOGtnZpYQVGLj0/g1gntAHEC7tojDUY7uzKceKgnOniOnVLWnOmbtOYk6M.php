...
class __TwigTemplate_02985a9abda6e04af970296b62b5cee3996d44f008cbf07fa2e92d2ef69c3fd3 extends \Twig\Template
{
 ...
 *   - type: The type of export (csv, json, xml).
...
<a href=\"{{ url }}\"{{ attributes.addClass('feed-icon') }}>
  {{ 'Download @type'|t({'@type': type}) }}
</a>
", "modules/contrib/views_data_export/templates/export-icon.html.twig", "/var/www/html/motc_qdgtp/modules/contrib/views_data_export/templates/export-icon.html.twig");
    }
}
